...
{
	#if HXCPP_M64
	private static inline var MAX_BYTES_VALUE:Int = 2147483644;
	...
	public function setDouble(pos:Int64, v:Float):Void
	{
		...
		if (blockBytesRemaining >= 8)
		{
			...
			secondBytes.blit(0, doubleBytes, blockBytesRemaining, doubleBytesRemaining);	
		}
	}
	...
	public function setFloat(pos:Int64, v:Float):Void
	{
		...
		if (blockBytesRemaining >= 4)
		{
			...
			secondBytes.blit(0, floatBytes, blockBytesRemaining, floatBytesRemaining);	
		}
	}
	...
	public function setInt32(pos:Int64, v:Int):Void
	{
		...
		if (blockBytesRemaining >= 4)
		{
			...
			secondBytes.blit(0, intBytes, blockBytesRemaining, intBytesRemaining);	
		}
	}
	...
	public function setUInt16(pos:Int64, v:Int):Void
	{
		...
		if (blockBytesRemaining >= 2)
		{
			...
			secondBytes.blit(0, uIntBytes, blockBytesRemaining, uIntBytesRemaining);	
		}
	}
	...
	private function _blitBytes(pos:Int64, src:Bytes, srcPos:Int, len:Int):Void
	{
		...
		if (len <= blockBytesRemaining)
		{
			...
			secondBytes.blit(0, src, blockBytesRemaining, totalBytesRemaining);
		}
	}
