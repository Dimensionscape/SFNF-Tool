...
abstract Version(String) from String to String
{
	...
	@:from private static inline function fromInt(value:Int):Version{
		if (value < 100)
		{
			throw "Version integer out of range";
		}

		var patch:Int = value % 1000; 
		var remainder:Int = Std.int(value / 1000);
		var minor:Int = Std.int(remainder % 1000); 
		var major:Int = Std.int(remainder / 1000); 
